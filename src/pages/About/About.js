    ...
    return (
        <div>
          <div className="head row">
             ...
             <div className="col-6 row my-5 g-3 pb-3">
                ...
                <div className="col-4 ">
                 ...
                 <div className="col-4">
                    <div className="bg-white text-dark rounded py-3 text-center">
                        <h1><i class="fas fa-mail-bulk"></i></h1>
                ...
                <div className="col-4">
                 ...
                 <div className="col-4">
                    <div className="bg-white text-dark rounded py-2 text-center">
                        <h1><i class="fal fa-laptop-house"></i></h1>
                 ...
                 <div className="col-4">
                    <div className="bg-white text-dark rounded py-3 text-center">
                    <h1><i class="fas fa-toolbox"></i></h1>
          ...
          <div className="counter row text-white">
              ...
              <div className="col-3 text-center">
                  <h1><i class="fas fa-atlas"></i></h1>
                  <h1>200+</h1>
                  <h1>Courses</h1>
              </div>
              <div className="col-3 text-center">
                  <h1><i class="fas fa-globe-africa"></i></h1>
                  <h1>50+</h1>
                  <h1>Countries</h1>
              </div>
          </div>
